...
# frame_path = "/root/autodl-fs/croped/soccer"
frame_path = output_root + "/outputs/soccer_image/soccer_4x"
# frame_path = "outputs/outputs_slowmotion"                

output_path = output_root + "/outputs/soccer_image/soccer_8x"

pretrained_path = "/root/MyCode/Valid/image_pyramid/Upload_image_pyramid/intrain_log" # pretrained RIFE path
shift = 0
...
if __name__ == "__main__":
    ...
    inference_video(model.simple_inference, frame_path, output_path, 3000)
